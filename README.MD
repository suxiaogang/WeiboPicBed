...
- 上传历史浏览和删除.
- 支持在常用在线markdown编辑器中使用两次ctrl+v粘贴图片，图片自动上传到微博图床。(目前已支持github，csdn及zybuluo的markdown在线编辑器)
...
#####在github中的使用效果
![](http://ww3.sinaimg.cn/large/99b8535cjw1f305ldkiclj215s0h9gq9.jpg)

#####在csdn中的使用效果
![](http://ww4.sinaimg.cn/large/99b8535cjw1f305kony68j21h80ldwmn.jpg)

#####在作业部落中的使用效果
![](http://ww2.sinaimg.cn/large/99b8535cjw1f30539xe2pj20qh0amjsv.jpg)
...
```
2016-04-18 v1.9
支持在常用Markdown在线编辑器中，使用两次Ctrl+V进行图片粘贴，目前已支持github, csdn及作业部落的在线markdown编辑器
