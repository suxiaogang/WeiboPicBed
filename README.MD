...
![](http://ww1.sinaimg.cn/large/5fd37818jw1evs4sp0nzjg20lt0e8n8o.gif)
...
> Q:我上传的图片去哪了?
>
> A:图片上传调用了这个接口 http://picupload.service.weibo.com/interface, 然而并不会存到你的微博相册里(即使你已经登陆了微博),在插件的设置页面,你可以看到本机上传的图片历史记录
