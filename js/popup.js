...
Wbpd.prototype={
                ...
                changePicFormat:function(pid,i){
                ...
                saveUrlToLocal:function(pid,image,i) {
                    if (Wbpd.prototype.is_batch>0&&arguments.length>1) {//批量模式
                        $('#res'+i).data('pid',pid);
                          ...
                          if (xhr.readyState === 4) {
                            if (xhr.status === 200 ) {
                              ...
                              try {
                                ...
                                global_pid = pid;
                                image_url=Wbpd.prototype.changePicFormat(pid,i);
                                Wbpd.prototype.saveUrlToLocal(pid,image_url,i);
